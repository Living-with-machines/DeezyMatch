...
setuptools.setup(
    ...
    python_requires='>=3.7',
    install_requires=['torch==1.5.0', 'torchvision==0.6.0', 'ipywidgets==7.5.1', 'PyYAML==5.3.1', 'scikit-learn==0.23.1', 'pandas==1.0.3', 'faiss-cpu==1.6.3', 'tqdm==4.46.0', 'tensorboard==2.2.2', 'matplotlib==3.2.1', 'jupyter-client==6.1.5', 'jupyter-core==4.6.3'],
    classifiers=[
