...
# set how often the progress should be printed
print_every = 500
...
for qc_mode in qc_modes_list:
    for rnn_pass in rnn_passes_list:
        ...
        outputpath = os.path.join("combined", combined_sc)
        ...
        path2vecs = os.path.join(query_candidate_mode, cq_sc, 
                                 f"embed_{query_candidate_mode}", 
                                 "rnn_" + rnn_pass + "*")
        path2ids = os.path.join(query_candidate_mode, cq_sc, 
                                f"embed_{query_candidate_mode}", "rnn_indxs*")
        pathdf = os.path.join(query_candidate_mode, cq_sc, f"{query_candidate_mode}.df")
        ...
        inp_par_dir = os.path.join(query_candidate_mode, cq_sc)
